...
.modal-footer>:not(:last-child) {
    ...
    <!-- slider_area_start -->
    <div class="slider_area" style="background-image: url(images/imagebank.jpg);">
        <div class="single_slider  d-flex align-items-center slider_bg_1 overlay"
            style="background-image: url(images/imagebank.jpg);">
            <div class="container">
                <div class="row align-items-center justify-content-start">
                    <div class="col-lg-10 col-md-10">
                        <div class="slider_text">
                            <h3 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s"
                                style="color: #FFC107; margin-left: -150px;  ">
                                <b style="color:#FFC107;font-family:algerian;">BASIC BANKING SYSTEM</b>
                            </h3>
                            <h2 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s"
                                style="color: #ffb3b3; margin-left: -147px; margin-top:-35px;">
                                 Money to be transferred between multiple accounts
                            </h2>
                            <br>
                            
                            <br>
                            <a name="getstarted" href="#services" style="margin-left: -142px; width: 50px; "
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb-70">
                        <span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s"
                            style="font-size: 50px; color:#BF1363; font-family:algerian;margin-top: -110px;" id="services"> SERVICES PROVIDED</span>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-4">
                        <div class="single_service text-center wow fadeInLeft" style="background-color:#FCDEC0;" data-wow-duration="1.2s"
                            data-wow-delay=".4s">
                            <!-- <a href="add.php"> -->
                            <button type="button" data-toggle="modal" data-target="#myModal">
                                <div class="icon">
                                    <img src="images\add_customer.png" alt="" height="70px" width="70px">
                                </div>
                                <h3 style="color:#39A6A3;"><b style="color:#39A6A3;">ADD CUSTOMER</b></h3>
                                <p>Add new customers to the list and then you are all set
                                    to transact</p>
                            </button>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 style="margin-left: 0px; color: red;"><b style="color:#39A6A3;">ADD CUSTOMER</b></h4>
                                </div>
                                    ...
                                    <form class="login100-form validate-form" action="insert.php" method="post">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button style="margin-left: -10px; margin-top:50px;" type="button"
                                                class="login100-form-btn btn-danger" data-dismiss="modal">Close</button>
                    ...
                    <div class="col-xl-4 col-md-4">
                        <div class="single_service text-center wow fadeInUp"style="background-color:#FCDEC0;" data-wow-duration="1s"
                            data-wow-delay=".3s">
                            <button type="button" onclick="window.location.href='transact.php'">
                                <div class="icon">
                                    <img src="images\transfer_money.png" alt="" height="74px" width="74px">
                                </div>
                                <h3 style="color:red;"><b style="color:#39A6A3;">TRANSFER MONEY</b></h3>
                    ...
                    <div class="col-xl-4 col-md-4" >
                        <div class="single_service text-center wow fadeInUp"style="background-color:#FCDEC0;" data-wow-duration="1s"
                            ...
                            <button type="button" onclick="window.location.href='view.php'">
                                <div class="icon">
                                    <img src="images\customer_view.png" alt="" height="74px" width="74px">
                                </div>
                                <h3 style="color:red;"><b style="color:#39A6A3;">VIEW CUSTOMERS</b></h3>
                                <p>View all the customers accounts in our bank</p>
                                <br>
                    </button>
                        </div>
