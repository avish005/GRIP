...
<body style="background: url(images/u1.jpg) no-repeat ; background-size: 1600px 1000px; opacity: 0.9; ">
	<div class="header">
		<a href="index.php"> 
		<button style="margin-left:483px; margin-top:20px; "class="login100-form-btn btn-danger">HOME</button>
		</a>

		<button style="margin-left:683px; margin-top:-50px; " type="button" data-toggle="modal" data-target="#myModal"
			class="login100-form-btn btn-danger" data-dismiss="modal">NEW TRANSACTION</button>
	</div>
    ...
    <div class="icon" style="color: #57b846; margin-left: px; margin-top:75px;">
                                    <img src="images/transaction_history.jpg" alt="" height="50px" width="50px">
                                </div>
  <div>
    <h2 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s"
        style="color:#FFC107;font-weight:bold;font-family:algerian;font-size:45px; margin-left: 50px; margin-top:-35px;">
